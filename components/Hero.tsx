    ...
    <section id="hero">
      <div className="hero-inner">
        ...
        <h1 className="hero-title">
          Building systems
          <br />
          that <span className="hero-hit-wrap"><Image src="/icons/erasebg-transformed.png" alt="" width={2112} height={1152} className="hero-hit-icon" aria-hidden /><em>hit</em></span>
          <br />
          their target.
        </h1>
